...
?>
        ...
        <tr>
            <td><?= $user['account_user']; ?></td>
            <td><?= $user['name_user']; ?></td>

            <td>
                <img src="<?= $user['avatar_user']; ?>"
                    alt="Avatar"
                    style="width:50px; height:50px; border-radius:50%; object-fit:cover;">
            </td>

            <td><?= date("d/m/Y", strtotime($user['birthday_user'])); ?></td>
            <td><?= $user['cmnd_user']; ?></td>
            ...
            <td align="center">
                <a href="delete_user.php?id=<?= $user['id_user']; ?>"
                   onclick="return confirm('Bạn thật sự muốn xóa không ?');">
                    <i class="fa fa-fw fa-trash" style="font-size:20px; color:#333;"></i>
                </a>
            </td>
        </tr>
        <?php endwhile; ?>
