    ...
    <ul class="sub">
        <li><a href="responsive_table.php">Danh sách danh mục</a></li>
                ...
                <li class="sub-menu"><a href="javascript:;"><i class="fa fa-tasks"></i><span>Quản lý đơn hàng</span></a>
                    <ul class="sub"><li><a href="form_component.php">Quản lý đơn hàng</a></li><li><a href="form_component.php">Danh sách đơn hàng </a></li></ul>
                </li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default" style="box-shadow:0 6px 18px rgba(0,0,0,0.04);">
          <div class="panel-heading"><strong>Thống kê sản phẩm bán chạy</strong>
...
$query = "
  SELECT 
    ...
    ANY_VALUE(o.code_order) AS code_order,
   ...
   GROUP_CONCAT(p.name_product SEPARATOR ', ') AS products,
    ...
    SUM(p.price_product * o.quantity_product) AS total_price,
    SUM(p.saleprice_product * o.quantity_product) AS sale_price,
    SUM(o.quantity_product) AS total_quantity_product,
    COUNT(*) AS count_order
  FROM tb_order o
  LEFT JOIN tb_product p ON p.id_product = o.id_product
  WHERE o.status_order = '0'
...
<tr>
 ...
 <td><?= $row['code_order'] ?></td>
    ...
    <!-- Số lượng -->
    <td><?= $row['total_quantity_product'] ?></td>

    <td><?= $row['order_day'] ?></td>
<td>
    <a href="order_detail.php?code_order=<?= $row['code_order'] ?>">
