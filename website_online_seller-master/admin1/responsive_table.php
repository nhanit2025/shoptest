...
<section id="main-content">
  <section class="wrapper">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default" style="box-shadow:0 6px 18px rgba(0,0,0,0.04);">
          <div class="panel-heading"><strong>Danh sách danh mục</strong> 
   ...
   ">
    Thêm
    <i class="fa fa-plus-square-o" style="font-size:25px; color:#1b926c;"></i>
</a>
          </div>
...
if (isset($_GET['btn-search']) && !empty($_GET['text_search'])) {
    ...
    $query = "SELECT * FROM tb_category 
              WHERE name_category LIKE '%$text_search%'";
} else {
    $query = "SELECT * FROM tb_category ORDER BY id_category DESC";
}
...
<td>
    <a href="edit_category.php?id=<?= $cat['id_category']; ?>">
        <i class="fa fa-pencil" style="color:#1b926c;"></i>
    </a>
</td>
<td><a href="delete_category.php?id=<?= $cat['id_category']; ?>" onclick="return confirm('Bạn chắc chắn muốn xóa?');">
