...
while ($product = mysqli_fetch_array($result_sp, MYSQLI_ASSOC)) {
    ?>
    <div class="see-product" style="background: #ffffffff" product="<?php echo $product['id_product']; ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-7 col-xs-12 right">
                    ...
                    <div class="col-sm-6 col-xs-12">
                        <div class="row">
                            <div style="color: red">Size<span style="font-size: 10px">*</span></div>
                            <div class="col-xs-12 option1">
                                <div class="row">
                                   <select name="size" class="select select-size" style="text-transform: uppercase; height: 40px; width: 140px; padding: 5px; font-size: 14px; box-sizing: border-box; border: 1px solid #ccc;">
    ...
    <option value="l">L</option>
                    ...
                    <div class="col-sm-5 col-sm-offset-1 col-xs-12">
                        <div class="row">
                            <div style="color: red">Số lượng<span style="font-size: 10px">*</span></div>
                            <input type="number" name="soluong" class="select select-soluong col-xs-12" value="1" style=" height: 40px !important;
...
<div class="container" style="margin:20px auto">
    ...
    <a href="sp-category.php?category=<?php echo $id_category; ?>"
...
?>
    <div class="item" style="flex: 1 1 20%; margin:1%">
        <div class="khung-img" style="border:1px solid #eee;  overflow:hidden; background:#fff; transition:0.3s;">
            
            <div class="item-img" style="width:100%; height:250px; overflow:hidden; position:relative;">
                <?php
                $img_product = explode(" ", $product['image_thump']);
                $i = 0;
                foreach ($img_product as $value) {
                ?>
                    <a href="product.php?id=<?php echo $product['id_product']; ?>">
                        <img 
                            title="<?php echo $product['name_product']; ?>" 
                            src="<?php echo $value; ?>" 
                            ...
                            style="
                                ...
                                object-fit:cover;
                                transition:0.4s;
                                <?php echo ($i == 1 ? 'position:absolute; top:0; left:0; opacity:0;' : ''); ?>
                            "
                            class="img<?php echo ($i == 1 ? '_1' : ''); ?>"
                        >
                    </a>
            ...
            <div class="text-center name" style="padding:10px 5px;">
    <a href="product.php?id=<?php echo $product['id_product']; ?>"
        style="text-transform: uppercase;color: #444; font-weight:600;"
        onmouseover="this.style.color='#000'"
        onmouseout="this.style.color='#000'">
        <?php echo $product['name_product']; ?>
            ...
            <div class="text-center price" style="color:red; font-weight:bold;">
                <?php echo number_format($product['saleprice_product'], 0, ',', '.'); ?>
            </div>

            <div class="button-product" style="text-align:center; padding:10px;">
